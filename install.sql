...
CREATE TABLE IF NOT EXISTS owners (
  ...
  notify_email TINYINT(1) DEFAULT 1 COMMENT 'používat pro odesílání informací',
  phone VARCHAR(30),
  whatsapp TINYINT(1) DEFAULT 0 COMMENT 'používat pro WhatsApp',
  ...
  unit_share_pct DECIMAL(5,2) NULL COMMENT 'podíl osoby na jednotce v % (podílové/SJM vlastnictví)',
...
CREATE TABLE IF NOT EXISTS owner_persons (
  ...
  relation VARCHAR(80),
  unit_share_pct DECIMAL(5,2) NULL COMMENT 'podíl osoby na jednotce v %',
  address VARCHAR(200),
  note TEXT,
  created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
  updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
